...
export default function HomeBanner() {
  ...
  return (
    <div className="max-h-[30rem] overflow-hidden relative">
      ...
      ></Image>
      <div className="absolute inset-0 flex items-center left-40">
        <div ref={target} className="flex flex-col text-white gap-6 font-bold">
          <div className="text-8xl">Review Ẩm Thực</div>
          <div className="text-4xl italic">
            Khám phá hương vị, trải nghiệm văn hóa
          </div>
          <button className="rounded-2xl border-2 border-dashed border-black bg-orange-300 px-6 py-3 font-semibold uppercase text-black transition-all duration-300 hover:translate-x-[-4px] hover:translate-y-[-4px] hover:rounded-md hover:shadow-[4px_4px_0px_#fb923c] active:translate-x-[0px] active:translate-y-[0px] active:rounded-2xl active:shadow-none">
            Xem thêm
          </button>
        </div>
      </div>
